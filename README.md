...
## Конфигурация
Приложение настраивается через переменные окружения. В коде предусмотрены значения по умолчанию для удобства запуска тестового задания.

> **Примечание**: Приведенные ниже значения (логины, пароли) являются тестовыми. В реальных проектах чувствительные данные должны передаваться исключительно через переменные окружения или специализированные хранилища секретов.
